...
router.put("/:id", checkIdMiddleware, (req, res) => adopterController.update(req, res))
router.delete("/:id", checkIdMiddleware, (req, res) => adopterController.destroy(req, res))
router.patch("/:id", checkIdMiddleware, validateBodyAddress, (req, res) => adopterController.updateAdopterAddress(req, res))
